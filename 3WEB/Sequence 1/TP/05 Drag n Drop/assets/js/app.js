...
(function(){
	...
	window.onload = function() {
		...
		favouritesView.addEventListener('dragover', function(event) {
			this.setAttribute('class', 'active');
			event.preventDefault();
		});

		favouritesView.addEventListener('dragleave', function(event) {
			this.removeAttribute('class');
		});

		favouritesView.addEventListener('drop', function(event) {
			this.removeAttribute('class');
			/* Make the drop */
